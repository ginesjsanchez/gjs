# GJS Python REST Server Archetype
...
Archetype to generate the basic structure of a basic REST server project in python language.
...
## Generación de un proyecto a partir del arquetipo
    ...
    mvn -B archetype:generate \
							...
							-DarchetypeArtifactId=gjs-pyhton-rest-server-archetype \
	...
	* mainFunction: The main REST server function. Default is Main:main. Not required.
