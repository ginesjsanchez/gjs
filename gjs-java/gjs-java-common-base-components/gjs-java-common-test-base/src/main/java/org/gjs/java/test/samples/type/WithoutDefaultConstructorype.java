...
@Getter
@Setter
public class WithoutDefaultConstructorype {
    ...
    public WithoutDefaultConstructorype(boolean boolVal, int intVal, short siVal, long lonVal, char carVal,
            double douVal, float floVal, Boolean obVal, Integer oiVal, Long olVal, Character ocVal, Double odVal,
            Float ofVal, String strVal, BigDecimal decVal, Date datVal, byte byVal, Byte obyVal) {
