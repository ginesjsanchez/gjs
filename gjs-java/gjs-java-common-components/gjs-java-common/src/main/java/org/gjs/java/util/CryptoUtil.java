 ...
 *
 * Función para calcular el hash de una secuencia de bytes en base a diferentes algoritmos.
 *
 * --------------------------------------------------------------------------------------------------------------------
...
public final class CryptoUtil {
     ...
     *            the bytes
     * @param algorithm
     *            the algorithm: SHA, MD2, MD5, SHA-256, SHA-384...
     * @return the string
     * @throws GjsException
     *             the semilla util exception
     */
