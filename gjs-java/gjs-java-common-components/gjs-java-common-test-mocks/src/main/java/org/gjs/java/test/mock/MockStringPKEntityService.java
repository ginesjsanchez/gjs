...
/**
 * The Class MockStringPKEntityService.
 *
 ...
 *
 */
public class MockStringPKEntityService<T, F> extends MockEntityService<T, String, F> {

    /**
     * Instantiates a new mock simple PK entity service.
     */
    public MockStringPKEntityService() {
    }
     ...
     *            the path
     */
    public MockStringPKEntityService(String path) {
        super(path);
    }
     ...
     */
    public MockStringPKEntityService(Resource resource) throws IOException {
