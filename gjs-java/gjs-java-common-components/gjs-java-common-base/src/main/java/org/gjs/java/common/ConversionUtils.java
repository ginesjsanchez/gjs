...
import org.gjs.java.types.GenericValue;
 ...
 *
 * Rutinas genéricas seguras de conversión de tipos que se utilzan en las rutinas de automatización de test de Semilla.
 *
 * --------------------------------------------------------------------------------------------------------------------
