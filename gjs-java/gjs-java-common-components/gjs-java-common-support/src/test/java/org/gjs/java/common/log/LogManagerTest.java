...
class LogManagerTest extends BaseClassTest<LogManager> {
	...
	private static class TestLogger extends LogManager {
	...
	public void testGetLogger1() {
		final TestLogger test = new TestLogger(this.logger);
		Logger logger = test.getLogger();
		assertNotNull(logger);
		assertEquals(getClass().getCanonicalName(), logger.getName());
	}
