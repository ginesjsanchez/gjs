...
int HorSumar ( int * p_iH, int * p_iM, int * p_iS, int iH, int iM, int iS )
{
	...
	{
		if ( HorEsValida ( *p_iH, *p_iM, *p_iS ) && HorEsValida ( iH, iM, iS ) )
		{
			*p_iS = *p_iS + iS;
			if ( *p_iS > 60 )
			{
