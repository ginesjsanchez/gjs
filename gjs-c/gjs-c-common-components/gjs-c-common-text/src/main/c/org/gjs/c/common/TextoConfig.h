...
#ifndef _ORG_GJS_C_CC_TEXTOCONFIG_H
#define _ORG_GJS_C_CC_TEXTOCONFIG_H
...
#include <PaginasCodigos.h>



/* Esto es necesario para el módulo ASCII: */
#define OEM850

#include <TextoConstantes.h>
